...
// Enable the send button when the user starts typing
...
async function fetchChatGPT(userMessage) {
    const apiKey = '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'; // Replace with your actual API key
    const url = 'https://api.openai.com/v1/completions'; // ChatGPT API endpoint
    const headers = {
    ...
    const data = {
        model: 'gpt-3.5-turbo', // Specify model version here
